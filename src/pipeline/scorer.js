...
export function scoreJob(job, keywords) {
  const W = FILTERS.WEIGHTS; // { keywords:35, recency:25, applicants:25, experience:10, easy_apply:5 }
  ...
  let applicantsScore = FILTERS.APPLICANTS_SCORE.undisclosed; // default
  ...
  let expScore = FILTERS.EXP_SCORE.acceptable; // default
  if (exp) {
  ...
  return {
    ...
    breakdown: {
      ...
      applicants: applicantsScore,
      experience: expScore,
      easy_apply: easyScore,
    },
  };
}
